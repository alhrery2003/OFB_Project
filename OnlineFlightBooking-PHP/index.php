				...
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content roundtrip">
						<form action="book_flight.php" method="post">
							...
							<div class="from">
								...
								echo '<option value="" selected disabled >Departure</option>';
							...
							<div class="to">
								...
								mysqli_stmt_execute($stmt);          
								$result = mysqli_stmt_get_result($stmt);    
								echo '<select name="arr_city" id="w3_country1" >';
								echo '<option value="" selected disabled>Arrival</option>';
								while ($row = mysqli_fetch_assoc($result)) {
								echo '<option value="' . $row['city'] . '">' . $row['city'] . '</option>';
								}
								echo '</select>';
							...
							<div class="date">
								<div class="depart">
									...
									<input class="form-control" name="dep_date" type="date"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" >
								</div>
								<div class="return">
									<h3 style="color: rgba(255, 255, 255, 0.767);">Return</h3>
									<input class="form-control"  name="ret_date" type="date" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" >
								</div>
								<div class="clear"></div>
							</div>
							<div class="class">
							...
							<div class="numofppl">
									...
									<div class="quantity"> 
										<div class="quantity-select">                           
											...
											<input type="hidden" name="passengers"
												class="input_val_passengers" value="1">											
								...
								<div class="clear"></div>
								<div class="adults">
									<h3 style="color: rgba(255, 255, 255, 0.767);">Days</h3>
									<div class="quantity"> 
										<div class="quantity-select">                           
											<div class="entry value-minus">&nbsp;</div>
											<div class="entry value"><span>1</span></div>
											<input type="hidden" name="days"
												class="input_val_days" value="1">											
											<div class="entry value-plus active">&nbsp;</div>
										</div>
									</div>
								</div>
								<div class="clear"></div>
								<input class="styled-submit" type="submit" value="Search All Flights" name="search_all_but_round">
							</div>
							<div class="clear"></div>
							<input class="notstyled-submit" type="submit" value="Search Flights" name="search_but">
						</form>						
					</div>
					<div class="tab-1 resp-tab-content oneway">
						<form action="book_flight.php" method="post">
							...
							<div class="date">
								<div class="depart">
									...
									<input name="dep_date" type="date" 
										class="form-control"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}">
								</div>
							</div>
							<div class="class">
								<h3 style="color: rgba(255, 255, 255, 0.767);">Class</h3>
							...
							<div class="clear"></div>
							<div class="numofppl">
								<!-- <input class="styled-submit" type="submit" value="Search All Flights" name="search_all_but"> -->
								<div class="adults">
									<h3 style="color: rgba(255, 255, 255, 0.767);">Passenger</h3>
									<div class="quantity"> 
										<div class="quantity-select">                           
								...
								<div class="clear"></div>
								<input class="styled-submit" type="submit" value="Search All Flights" name="search_all_but_one">
							</div>
							<div class="clear"></div>
							<input class="notstyled-submit" type="submit" value="Search Flights" name="search_but">
						</form>							
...
<div class="conatiner-fluid p-4" style="background-color: whitesmoke;margin-top:150px;">
   <!-- <h2 class="text-center mb-3 mt-3 display-4"
	   style="font-style: normal;font-size:80px;">Main Attractions In Egypt</h2>   
...
<!-- <div class="conatiner-fluid p-4" style="background-color: whitesmoke;margin-top:150px;"> -->
	...
	<div class="text-light text-center">&copy; <?php echo date('Y')?> - Developed By Abdalrhman Alhrery<br><br></div>
	<!-- <p>----------</p> -->
    ...
    <?php subview('footer.php'); ?> 
		...
		// });
		$('.value-plus').on('click', function(){
        var parent = $(this).closest('.quantity-select');
        var divUpd = parent.find('.value');
        var newVal = parseInt(divUpd.text(), 10) + 1;

        divUpd.text(newVal);
        parent.find('input').val(newVal);  // Update the specific input field within the parent
    	});
