...
.dashbord-red .detail-section{
      ...
      <div class="card-body">
        ...
        <table class="table-sm table table-hover">
          ...
          <tbody>               
            ...
            $sql_round = "SELECT * FROM Round_flight WHERE flight_id=?";
            $stmt_round = mysqli_stmt_init($conn);
            mysqli_stmt_prepare($stmt_round,$sql_round);
            mysqli_stmt_bind_param($stmt_round,'i',$row['flight_id']);
            mysqli_stmt_execute($stmt_round);
            $result_round = mysqli_stmt_get_result($stmt_round);
            if ($row_round = mysqli_fetch_assoc($result_round)) {
            ...
            <td scope="row">
              <a href="pass_list.php?flight_id='.$row['flight_id'].'">
              '.$row['flight_id'].' </a> </td>
            <td>'.$row_round['arrivale'].'</td>
            <td>'.$row_round['departure'].'</td>
            <td>'.$row_round['source'].'</td>
            <td>'.$row_round['Destination'].'</td>
            <td>'.$row['airline'].'</td> 
            <th class="options">
              <div class="dropdown">
                <button class="btn btn-info dropdown-toggle" type="button" 
                ...
                <div class="dropdown-menu">
                  <form class="px-4 py-3"  action="../includes/admin/admin.inc.php" method="post">
                    ...
                    <input type="hidden" type="number" name="round_flight_id" value='.$row_round['round_flight_id'].'>
                    <div class="form-group">
                      <label for="exampleDropdownFormEmail1">Enter time in min.                              
                      </label>
                      <input type="number" class="form-control" name="issue" 
    ...
    <div class="card" id="issue">
      <div class="card-body">
        ...
        <p class="text-secondary">Flight Issues</p>
        <table class="table-sm table table-hover">
        <thead class="thead-dark">
            <tr> 
              <th scope="col">#</th>
    ...
    <div class="card" id="dep">
      <div class="card-body">
        ...
        <p class=" text-secondary">Flights Departed</p>
        <table class="table-sm table table-hover">
        <thead class="thead-dark">
            <tr> 
              <th scope="col">#</th>
    ...
    <div class="card mb-4" id="arr">
      <div class="card-body">
        ...
        <p class=" text-secondary">Flights Arrived</p>
        <table class="table-sm table table-hover">
        <thead class="thead-dark">
            <tr> 
              <th scope="col">#</th>
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      <form class="px-4 py-3"  action="../includes/admin/admin.inc.php" method="post">
                        <input type="hidden" type="number" name="flight_id" 
                          value='.$row['flight_id'].'>
                        <button type="submit" name="rev_but" 
                          class="btn btn-danger">Reverse !!</button>
                      </form>
                    </div>
                  </div>  
                </th>               
